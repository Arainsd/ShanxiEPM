...
{
    public class MessageListController : BaseController
    {
        // GET: SMSList
        [AuthCheck(Module = AdminModule.MessageList, Right = SystemRight.Browse)]
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [AuthCheck(Module = AdminModule.MessageList, Right = SystemRight.Info)]
