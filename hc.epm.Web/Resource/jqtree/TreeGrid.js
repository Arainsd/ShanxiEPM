    ...
    drowRowData = function (_rows, _cols, _level, _pid) {
        ...
        for (var i = 0; i < _rows.length; i++) {
            ...
            for (var j = 0; j < _cols.length; j++) {
                ...
                } else if (col.childCustom && !(row.children && row.children.length > 0)) {
                    s += (eval(col.childCustom + ".call(new Object(), row, col)") || "") + "</td>";
                } else {
...
//公共静态变量
TreeGrid.FOLDER_OPEN_ICON = "/Content/jqtree/img/folderOpen.gif";
TreeGrid.FOLDER_CLOSE_ICON = "/Content/jqtree/img/folderClose.gif";
TreeGrid.DEFAULT_LEAF_ICON = "/Content/jqtree/img/defaultLeaf.gif";
TreeGrid.COUNT = 1;
